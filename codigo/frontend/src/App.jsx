  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/clientes/:cuit/etiquetas"      element={<PrivateRoute><ClienteEtiquetas /></PrivateRoute>} />
        ...
        <Route path="/admin/permisos"                element={<PrivateRoute requireAdmin={true}><Permisos /></PrivateRoute>} />
